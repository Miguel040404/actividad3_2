  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <img className="w-[400px] h-[450px] self-center mt-8" title="Expediente" alt="Expediente" src="https://www.juntadeandalucia.es/educacion/gestionafp/documentacion/Informacion_tutorial/pen-162124_1280.png" width="960" height="720" />
