  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <img className="w-[300px] h-[332px] border-2 border-black self-center mt-8" title="Calendario" alt="Calendario" src="https://www.juntadeandalucia.es/educacion/gestionafp/documentacion/Informacion_tutorial/calendar-1231038_960_720.jpg" width="960" height="720" />
